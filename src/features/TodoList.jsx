...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col mt-4 gap-1">
      ...
      <nav className="flex justify-between items-baseline gap-2 my-1">
        <div className="flex gap-2 items-baseline">
          <span className="text-lg">Page : </span>
          <input className="border border-blue-400 w-12 text-center pl-2" min='1' max={pageInfo?.allPage} type="number" value={page} onChange={(e) => setPage(e.target.value)} />
